...
connection and revokes affected circuits. Disconnect, Shakescape loss, reservation
...
types owned by the built-in Shakescape, HIP-76, ODoH, and HNSR runtimes, preserving
