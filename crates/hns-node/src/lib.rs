...
pub use wallet_backend::{
    ...
    CompletedTrackedContractRetirementRequest, ConfirmedScriptHistory, ConfirmedScriptUtxo,
...
// avoiding the measured random-read amplification of rewriting an increasingly
// large live tree too often. Routine reclamation resumes as soon as native sync
