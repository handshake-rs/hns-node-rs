...
pub use wallet_backend::{
    ...
    FeeEstimate, FeeEstimateSource, IncomingTransferSourceBinding, IncomingTransfersCursor,
    IncomingTransfersPage, MempoolContractActivity, MempoolContractEvent, MempoolContractPage,
    MempoolScriptActivity, MempoolScriptOutput, MempoolScriptPage, MempoolScriptSpend, NameAction,
    NameActionContext, NameActionIneligibility, NameEvidence, NameOwnerTransaction,
    NameProofResult, NameRenewalContext, NameTransferContext, OutpointSpendingEntry,
    OutpointSpendingEvidence, TrackedContractRetirement, TrackedContractRetirementContext,
    TrackedContractRetirementRequest, TransactionEvidence, TransactionFeeQuote,
    TransactionInclusion, TransactionPayload, TransactionStatus, WalletBackend, WalletBackendError,
    WalletChainSnapshot, WalletChainTip, WalletContractEventCursor, WalletContractEventPage,
    WalletContractFundingCursor, WalletContractFundingPage, WalletIncomingTransfer,
    WalletMempoolCursor, INCOMING_TRANSFER_PROJECTION_VERSION,
